...
import { useGetExpensesByCategoryQuery } from '@/state/api/expense'
    ...
    <>
      ...
      <div className='flex flex-col justify-between gap-4 md:flex-row'>
        <div className='w-full rounded-lg bg-white p-6 shadow md:w-1/3'>
          <h3 className='mb-4 text-lg font-semibold'>Filter by Category and Date</h3>
        ...
        <div className='grow rounded-lg bg-white p-4 shadow md:p-6'>
          <ResponsiveContainer
            width='100%'
            height={400}>
            <PieChart>
